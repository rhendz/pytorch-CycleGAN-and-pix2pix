...
resize_images("./datasets/apple2orange/testA", 32)
resize_images("./datasets/apple2orange/testB", 32)
resize_images("./datasets/apple2orange/trainA", 32)
resize_images("./datasets/apple2orange/trainB", 32)